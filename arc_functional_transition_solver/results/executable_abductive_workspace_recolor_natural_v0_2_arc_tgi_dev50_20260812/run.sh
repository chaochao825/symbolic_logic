...
out="$repo/results/executable_abductive_workspace_recolor_natural_v0_2_arc_tgi_dev50_20260812"
...
protocol="$repo/notes/research/executable-abductive-workspace-recolor-natural-audit-v0.2-20260812.md"
...
git status --short -- \
  ...
  src/afts_arc/recolor_topology_gate.py \
  scripts/afts_executable_workspace_recolor_gate.py \
  scripts/afts_recolor_topology_natural_gate.py \
  tests/test_executable_workspace.py \
  tests/test_recolor_topology_gate.py \
  notes/research/executable-abductive-workspace-recolor-topology-v0.2-gate-20260812.md \
  notes/research/executable-abductive-workspace-recolor-natural-audit-v0.2-20260812.md \
...
freeze_one() {
  ...
  /usr/bin/time -v env PYTHONPATH=src \
    python scripts/afts_recolor_topology_natural_gate.py freeze \
...
score_one() {
  local label="$1"
  env PYTHONPATH=src python scripts/afts_recolor_topology_natural_gate.py score \
