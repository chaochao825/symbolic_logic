...
52. [Guichard et al., *ARC-NCA: Towards Developmental Solutions to the Abstraction and Reasoning Corpus* (2025)](https://arxiv.org/abs/2505.08778), with [author code](https://github.com/etimush/ARC_NCA). Evaluates task-specific NCA/EngramNCA variants on ARC-AGI-1 public evaluation after excluding most resize tasks; the authors report single-run results and separate single-model from top-2 unions.
